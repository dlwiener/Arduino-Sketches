// dw Array Cycle Digits on Display
...
// n is an array of 12 integers
int n[12] = { 0, 96, 93, 117, 102, 55, 63, 97, 127, 103, 123, 128 };
...
void loop() {
  for (int i = 0; i < 12; ++i) {
    ...
    shiftOut(segmentData, segmentClock, MSBFIRST, n[i]);

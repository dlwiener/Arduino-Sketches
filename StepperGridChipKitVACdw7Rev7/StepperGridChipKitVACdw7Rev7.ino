...
{ 
 switch (runID)
 {
    case 1:      //dw low speed-low amplitude run
    ...
    case 3:   //dw low speed-high amplitude run  
          digitalWrite(conveyorPin, HIGH);
    ...
    case 4:   // high speed-high amplitude run
          ...
          clear_Leds_turn_off_sound();
          delay(10);
          run_Vacuum(8000);       // run vacuum for 8 sweconds

...
void runAuto(int runID)
{
  switch (runID)
  {
    case 1:      // low speed
      ...
      runMotor(250, 125, -2048*1, 1);  //runMotor(int MaxSpeed, int Acceleration, int newPos, int j)
      // 2048 = 1/2 revolution
      // should reach max speed in 2 seconds
    ...
    case 2:    // medium speed
      ...
      runMotor(1000, 500, -2048*2, 2);  //runMotor(int MaxSpeed, int Acceleration, int newPos, int j)
      // 2048 = 1/2 revolution
      // should reach max speed in 2 seconds
    ...
    case 3:   //  high speed
      ...
      runMotor(2000, 1000, -2048*4, 3);  //runMotor(int MaxSpeed, int Acceleration, int newPos, int j)
      // 2048 = 1/2 revolution
      // should reach max speed in 2 seconds
    ...
    case 4:   // ultra speed
      ...
      runMotor(3000, 1500, -2048*8, 4);  //runMotor(int MaxSpeed, int Acceleration, int newPos, int j)
      // 2048 = 1/2 revolution
      // should reach max speed in 2 seconds

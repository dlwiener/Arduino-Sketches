...
/* This version 4 software is for a four button interface, to choose instant start of the following:
 low speed, low amplitude run (Corner1)        Corner1 *-------* Corner2
 low speed, high amplitude run (Corner2)               -       -
 high speed, low amplitude run (Corner3)       Corner3 *-------* Corner4
 high speed, high amplitude run (corner4)
*/
...
{ 
 switch (runID)
 {
    case 1:      // low speed-low amplitude run
          digitalWrite(conveyorPin, HIGH); 
          digitalWrite(7, HIGH); // turn on low speed-low amplitude led indicator
          tone(36, NOTE_A3);
          runMotor(482, 482, -750, 2);  //463 was Period 5.2 sec, low speed low amplitude (dw changed 4 to 2) 
          digitalWrite(conveyorPin, LOW);
          clear_Leds_turn_off_sound();
          delay(10);  
          run_Vacuum(8000);
    ...
    case 2:    // dw high speed-low amplitude run 
          digitalWrite(conveyorPin, HIGH);
          digitalWrite(5, HIGH);        // turn on low speed-high amplitude led indicator
          tone(36, NOTE_A5);
          runMotor(3061, 3061, -750, 5);   // low speed, high amplitude run  (dw changed 9 to 5)
          digitalWrite(conveyorPin, LOW);
          clear_Leds_turn_off_sound();
          delay(10);
          run_Vacuum(8000);
    ...
    case 3:   // low speed-high amplitude run  
          digitalWrite(conveyorPin, HIGH);
          digitalWrite(28, HIGH); // turn on high speed-low amplitude led indicator
          tone(37, NOTE_A3);
          runMotor(1284, 1284, -2000, 2);  // high speed low amplitude run  (dw changed 4 to 2)
          digitalWrite(conveyorPin, LOW);
          clear_Leds_turn_off_sound();
          delay(10);
          run_Vacuum(8000);
    ...
    case 4:   // dw high speed-high amplitude run
          digitalWrite(conveyorPin, HIGH);  // Turn on conveyor belt
          digitalWrite(30, HIGH); // turn on high speed/high amplitude led indicator
          tone(37, NOTE_A5);
          runMotor(8163, 8163, -2000, 6); // high speed-high amplitude profile  (dw changed 11 to 6)
          digitalWrite(conveyorPin, LOW);
          clear_Leds_turn_off_sound();
          delay(10);

              // dw high speed-low amplitude run (?dw thinks this one is Hi/Lo)
          digitalWrite(conveyorPin, HIGH);
          digitalWrite(5, HIGH);        // turn on low speed-high amplitude led indicator
          tone(36, NOTE_A5);
          runMotor(3061, 3061, -750, 5);   // low speed, high amplitude run  (dw changed 9 to 5)
          ...
          delay(10);
              ...
              // dw low speed-high amplitude run  (?dw thinks this one=e is Lo/Hi)
          digitalWrite(conveyorPin, HIGH);
          digitalWrite(28, HIGH); // turn on high speed-low amplitude led indicator
          tone(37, NOTE_A3);
          runMotor(1284, 1284, -2000, 2);  // high speed low amplitude run  (dw changed 4 to 2)
          ...
          run_Vacuum(14000);       // run vacuum for 8 sweconds

/*
  ...
  dw MOTOR gets Hot if you leave it on for more than 3 minutes!  "disableOutputs()" kills all coil current preventing motor from getting hot.
...
void setup() {
  ...
  stepperX.disableOutputs();    // stops motor from overheating when off
